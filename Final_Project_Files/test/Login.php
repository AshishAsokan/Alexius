...
<html lang="en">
    ...
    <body style="overflow: hidden">
       ...
       <div class="topnav">
        ...
        <div id="div1">
            <img id="slogan-logo" src="alexius-slogan.png" height="130" width="370">
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="submit" class="btnContact" id="submit_but" name="submit_button" value="Login" />
                            <a href="ForgotPassword.html" class="fpass"><p class="fpass">Forgot Password?</p></a>
                        </div>
                    </div>
                </div>
            </form>
